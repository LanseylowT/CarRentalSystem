...
{
    public partial class AvailableCarsPageTest : Form
    {
        ...
        // TODO: If the cell is clicked, the Car ID text box and price should be read-only
        ...
        private void AvailableCarsPageTest_Load(object sender, EventArgs e)
        {
            SetupDataGridView();
            LoadCarDataIntoDataGrid();
        }
